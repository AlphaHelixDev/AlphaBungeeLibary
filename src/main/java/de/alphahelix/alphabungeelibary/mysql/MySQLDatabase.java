...
public class MySQLDatabase implements Serializable {
    ...
    /**
     * Checks if the UUID of a {@link ProxiedPlayer} is inside the table
     *
     * @param p the {@link ProxiedPlayer} to check
     * @return if the {@link ProxiedPlayer} is inside the table
     */
    public boolean containsPlayer(ProxiedPlayer p) {
     ...
     * Checks if the UUID of a {@link ProxiedPlayer} is inside the table
     *
     * @param playername the name of the {@link ProxiedPlayer} to check
     * @return if the {@link ProxiedPlayer} is inside the table
     */
     ...
     * Checks if the UUID of a {@link ProxiedPlayer} is inside the table
     *
     * @param id the UUID of the {@link ProxiedPlayer} to check
     * @return if the {@link ProxiedPlayer} is inside the table
     */
